...
try:
    from kartoza_geonode.local_settings import *
except ImportError:
    from kartoza_geonode.settings import *
...
def _reset():
    ...
    sh(f"rm -rf {path}")
    sh("rm -rf kartoza_geonode/development.db")
    sh("rm -rf kartoza_geonode/uploaded/*")
    _configure_data_dir()
