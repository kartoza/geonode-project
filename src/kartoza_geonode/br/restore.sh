...
echo "-----------------------------------------------------"
echo "STARTING kartoza_geonode RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./kartoza_geonode/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED kartoza_geonode RESTORE $(date)"
echo "-----------------------------------------------------"
