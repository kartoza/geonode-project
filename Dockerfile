...
RUN mkdir -p /usr/src/kartoza_geonode
...
COPY src /usr/src/kartoza_geonode/
WORKDIR /usr/src/kartoza_geonode
...
RUN chmod +x /usr/src/kartoza_geonode/tasks.py \
    && chmod +x /usr/src/kartoza_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/kartoza_geonode/entrypoint.sh
